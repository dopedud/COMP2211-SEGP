...
public class CalculatorTest {
  ...
  private static Obstacle obstacle12H0N, obstacle25H20S, obstacle15H60N, obstacle20H20N;
  ...
  public void takeOffTowardsObs1() {
    ...
    assertEquals(2986, runway27R.getCtora(), "Calculated TORA of runway is incorrect after calculation.");
    assertEquals(2986, runway27R.getCtoda(), "Calculated TODA of runway is incorrect after calculation.");
    assertEquals(2986, runway27R.getCasda(), "Calculated ASDA of runway is incorrect after calculation.");
  }
  ...
  public void takeOffAwayObs1() {
    ...
    assertEquals(3346, runway09L.getCtora(), "Calculated TORA of runway is incorrect after calculation.");
    assertEquals(3346, runway09L.getCtoda(), "Calculated TODA of runway is incorrect after calculation.");
    assertEquals(3346, runway09L.getCasda(), "Calculated ASDA of runway is incorrect after calculation.");
  }
  ...
  public void landingTowardsObs1() {
    ...
    assertEquals(3346, runway27R.getClda(), "Calculated LDA of runway is incorrect after calculation.");
  }
  ...
  public void landingOverObs1() {
    ...
    assertEquals(2985, runway09L.getClda(), "Calculated LDA of runway is incorrect after calculation.");
  }
  ...
  public void takeOffTowardsObs2() {
    ...
    assertEquals(1850, runway09R.getCtora(), "Calculated TORA of runway is incorrect after calculation.");
    assertEquals(1850, runway09R.getCtoda(), "Calculated TODA of runway is incorrect after calculation.");
    assertEquals(1850, runway09R.getCasda(), "Calculated ASDA of runway is incorrect after calculation.");
  }
  ...
  public void takeOffAwayObs2() {
    ...
    assertEquals(2860, runway27L.getCtora(), "Calculated TORA of runway is incorrect after calculation.");
    assertEquals(2860, runway27L.getCtoda(), "Calculated TODA of runway is incorrect after calculation.");
    assertEquals(2860, runway27L.getCasda(), "Calculated ASDA of runway is incorrect after calculation.");
  }
  ...
  public void landingTowardsObs2() {
    ...
    assertEquals(2553, runway09R.getClda(), "Calculated LDA of runway is incorrect after calculation.");
  }
  ...
  public void landingOverObs2() {
    ...
    assertEquals(1850, runway27L.getClda(), "Calculated LDA of runway is incorrect after calculation.");
  }
  ...
  public void takeOffTowardsObs3() {
    ...
    assertEquals(2393, runway27L.getCtora(), "Calculated TORA of runway is incorrect after calculation.");
    assertEquals(2393, runway27L.getCtoda(), "Calculated TODA of runway is incorrect after calculation.");
    assertEquals(2393, runway27L.getCasda(), "Calculated ASDA of runway is incorrect after calculation.");
  }
  ...
  public void takeOffAwayObs3() {
    ...
    assertEquals(2903, runway09R.getCtora(), "Calculated TORA of runway is incorrect after calculation.");
    assertEquals(2903, runway09R.getCtoda(), "Calculated TODA of runway is incorrect after calculation.");
    assertEquals(2903, runway09R.getCasda(), "Calculated ASDA of runway is incorrect after calculation.");
  }
  ...
  public void landingTowardsObs3() {
    ...
    assertEquals(2903, runway27L.getClda(), "Calculated LDA of runway is incorrect after calculation.");
  }
  ...
  public void landingOverObs3() {
    ...
    assertEquals(2393, runway09R.getClda(), "Calculated LDA of runway is incorrect after calculation.");
  }
  ...
  public void takeOffTowardsObs4() {
    ...
    assertEquals(2792, runway09L.getCtora(), "Calculated TORA of runway is incorrect after calculation.");
    assertEquals(2792, runway09L.getCtoda(), "Calculated TODA of runway is incorrect after calculation.");
    assertEquals(2792, runway09L.getCasda(), "Calculated ASDA of runway is incorrect after calculation.");
  }
  ...
  public void takeOffAwayObs4() {
    ...
    assertEquals(3534, runway27R.getCtora(), "Calculated TORA of runway is incorrect after calculation.");
    assertEquals(3612, runway27R.getCtoda(), "Calculated TODA of runway is incorrect after calculation.");
    assertEquals(3534, runway27R.getCasda(), "Calculated ASDA of runway is incorrect after calculation.");
  }
  ...
  public void landingTowardsObs4() {
    ...
    assertEquals(3246, runway09L.getClda(), "Calculated LDA of runway is incorrect after calculation.");
  }
  ...
  public void landingOverObs4() {
    ...
    assertEquals(2774, runway27R.getClda(), "Calculated LDA of runway is incorrect after calculation.");
  }
}
